...
def load_model(model_path: str):
    ...
    Returns:
        Loaded LinearRegression model with L2 regularization
    """
...
def save_results_to_file(metrics: dict, y_true: np.ndarray, y_pred: np.ndarray, project_root: str):
    ...
    results_file = os.path.join(results_dir, 'ridge_model_test_results.txt')
    
    with open(results_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("LAPTOP PRICE PREDICTION - RIDGE REGRESSION MODEL TEST RESULTS\n")
        f.write("=" * 80 + "\n\n")
        
        f.write("MODEL INFORMATION:\n")
        f.write("-" * 40 + "\n")
        f.write("Model Type: Ridge Regression (Linear Regression with L2 Regularization)\n")
...
def main():
    """Main function to test the Ridge Regression model."""
    ...
    print("=" * 60)
    print("LAPTOP PRICE PREDICTION - RIDGE MODEL TESTING")
    print("=" * 60)
