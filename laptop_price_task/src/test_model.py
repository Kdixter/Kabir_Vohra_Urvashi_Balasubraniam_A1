...
def save_results_to_file(metrics: dict, y_true: np.ndarray, y_pred: np.ndarray, project_root: str):
    ...
    results_file = os.path.join(results_dir, 'linear_model_test_results.txt')
    
    with open(results_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("LAPTOP PRICE PREDICTION - LINEAR REGRESSION MODEL TEST RESULTS\n")
        f.write("=" * 80 + "\n\n")
...
def main():
    """Main function to test the linear regression model."""
    ...
    print("=" * 60)
    print("LAPTOP PRICE PREDICTION - MODEL TESTING")
    print("=" * 60)
