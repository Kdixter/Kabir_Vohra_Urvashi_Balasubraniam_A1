...
# Add the current directory to Python path to import the RandomForest class
...
def save_results_to_file(metrics: dict, y_true: np.ndarray, y_pred: np.ndarray, project_root: str):
    ...
    results_file = os.path.join(results_dir, 'random_forest_model_test_results.txt')
    
    with open(results_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("LAPTOP PRICE PREDICTION - RANDOM FOREST MODEL TEST RESULTS\n")
        f.write("=" * 80 + "\n\n")
        
        f.write("MODEL INFORMATION:\n")
        f.write("-" * 40 + "\n")
        f.write("Model Type: Random Forest (from scratch)\n")
...
def main():
    """Main function to test the Random Forest model."""
    ...
    print("=" * 60)
    print("LAPTOP PRICE PREDICTION - RANDOM FOREST MODEL TESTING")
    print("=" * 60)
