...
from train_1 import LinearRegression
...
def save_results_to_file(metrics: dict, y_true: np.ndarray, y_pred: np.ndarray, project_root: str):
    ...
    results_file = os.path.join(results_dir, 'linear_model_results.txt')
    
    with open(results_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("LIFE EXPECTANCY PREDICTION - LINEAR REGRESSION MODEL TEST RESULTS\n")
        f.write("=" * 80 + "\n\n")
        
        f.write("MODEL INFORMATION:\n")
        f.write("-" * 40 + "\n")
        f.write("Model Type: Linear Regression (from scratch)\n")
...
def main():
    """Main function to test the linear regression model for life expectancy."""
    ...
    print("=" * 60)
    print("LIFE EXPECTANCY PREDICTION - MODEL TESTING")
    print("=" * 60)
